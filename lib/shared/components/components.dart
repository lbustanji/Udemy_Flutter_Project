...
import 'package:udimy_flutter/modules/news_app/web_view/web_view_screen.dart';
        ...
        child: Row(
          children: [
            ...
            IconButton(
              onPressed: () {
                AppCubit.get(context)
                    .updateDatabaseRecord(status: 'done', id: model['id']);
              },
            ...
            IconButton(
              onPressed: () {
                AppCubit.get(context)
                    .updateDatabaseRecord(status: 'archived', id: model['id']);
              },
...
Widget buildArticleItem(article, context, index) => Container(
      color: NewsCubit.get(context).businessSelectedItem==index &&  NewsCubit.get(context).isDesktop
          ? Colors.grey[200]
          : null,
      child: InkWell(
        onTap: () {
